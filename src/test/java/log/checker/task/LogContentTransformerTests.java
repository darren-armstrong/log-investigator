...
public class LogContentTransformerTests {
    ...
    public void testOneGetDataFromLine(){
        ...
        String expectedDate = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(new java.util.Date());
        ...
        doReturn(expectedDate).when(logContentTransformerSpy).getDateFromLine(anyString());

        dataFromLine = logContentTransformerSpy.getDataFromLine(lineFromLog);
